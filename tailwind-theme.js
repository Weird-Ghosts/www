...
export default {
  ...
  global: {
    ...
    label: "block text-xl font-bold leading-6 text-black sm:pt-2 mb-2",
    ...
    outer:
      "md:grid md:grid-cols-2 md:gap-x-8 mb-4 formkit-disabled:opacity-50 mt-6 sm:mt-5 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5",
    prefixIcon:
  ...
  "family:button": {
    input:
      "$reset text-xl inline-flex items-center bg-red-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-red-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin",
    wrapper: "mb-1",
...
// Specific styles apply only to a given input name
