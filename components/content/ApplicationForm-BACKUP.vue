  ...
  <div class="text-xl sm:text-xl bg-white z-30 relative p-4 lg:p-12">
    <form
      ...
      <div>
          ...
          <div
            ...
            <div class="p-6">
              ...
              <ul>
                <li>
                  <nuxt-link
                    to="/faq#whats-the-eligibility-criteria-for-funding"
        ...
        <div>
          <div>
            <h3 class="text-3xl leading-6 font-black text-black uppercase">
              About you
            </h3>
          </div>
              ...
              <div class="mt-1 sm:mt-0 sm:col-span-2">
                <div class="max-w-lg rounded-md shadow-sm">
                  <input
                    ...
                    type="email"
                    class="form-input block w-full rounded-md transition duration-150 ease-in-out sm:text-lg sm:leading-5" />
                </div>
              </div>
            </div>
        ...
        <div class="mt-8 border-t border-gray-200 pt-8 sm:mt-5 sm:pt-10">
          <div>
            <h3 class="font-black text-3xl uppercase leading-6 text-gray-900">
              About your studio
            </h3>
            <p class="label-subheading">
          ...
          <div
            ...
            <label
              ...
              Studio name
              <p class="label-subheading">
                What is the name of your studio, if you have one?
              </p>
            </label>
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <div class="max-w-lg flex rounded-md shadow-sm">
          ...
          <div
            ...
            <label
              ...
              Concept
              <p class="label-subheading">
                Describe your dream studio, including business structures you’re
                interested in, size, and values.
              </p>
            </label>
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <div class="max-w-lg flex rounded-md shadow-sm">
          ...
          <div
            ...
            <label
              ...
              Team
              <p class="label-subheading">
                Provide short bios for each of your team members, if any.
              </p>
              <p class="label-subheading mt-8">
                What will you be looking for in collaborators or co-op members
                if you intend to grow your team?
              </p>
            </label>
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <div class="max-w-lg flex rounded-md shadow-sm">
          ...
          <div
            ...
            <label
              ...
              Game
              <p class="label-subheading">
                Tell us about the game you are working on now, if applicable.
              </p>
            </label>
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <div class="max-w-lg flex rounded-md shadow-sm">
            ...
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <div class="max-w-lg flex rounded-md shadow-sm">
                <textarea
                  ...
                  rows="6"
                  class="form-textarea block rounded-md w-full transition duration-150 ease-in-out sm:text-lg sm:leading-5"></textarea>
              </div>
              <p class="mt-2 text-lg text-gray-600"></p>
            </div>
          </div>
        ...
        <div class="mt-8 pt-8 sm:mt-5 sm:pt-10">
          <div
            ...
            <label
              for="comments"
              class="block text-xl font-bold rounded-md leading-5 text-black sm:mt-px sm:pt-2">
              Comments
              <p class="label-subheading">
            ...
            <div class="mt-1 sm:mt-0 sm:col-span-2">
              <div class="max-w-lg flex rounded-md shadow-sm">
                <textarea
                  ...
                  rows="6"
                  class="form-textarea block w-full rounded-md transition duration-150 ease-in-out sm:text-lg sm:leading-5"></textarea>
              </div>
            </div>
          </div>
      ...
      <div class="mt-8 border-gray-300 pt-5">
        <div class="flex justify-start">
          <span class="inline-flex shadow-sm">
            <button
              type="submit"
              class="inline-block w-full justify-center py-4 px-8 border border-transparent text-2xl leading-5 font-medium text-white bg-body hover:bg-primary focus:outline-none focus:border-body focus:shadow-outline-indigo active:bg-body transition duration-150 ease-in-out">
              Submit Application
            </button>
          </span>
        </div>
