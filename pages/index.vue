<template>
    <div class="py-6 sm:pb-16 md:pb-20 lg:pb-28 ">
      <section class="lg:pt-20">
        <div class="lg:grid lg:grid-cols-2 lg:gap-8 mx-auto max-w-6xl">
          ...
          <div class="bg-primary md:bg-transparent md:p-0">
            <div class="text pr-4">
              <h2>
                An impact fund for studios led by underrepresented founders
                across Canada.
              </h2>
      ...
      <section class="w-full text-lg  py-12">
        <div>
          <div
            class="relative lg:grid lg:grid-cols-2 lg:gap-8 max-w-6xl mx-auto"
          >
      ...
      <section id="features" class="mx-auto bg-body text-primary py-12">
        <div class="text-center mx-auto max-w-2xl mb-12">
          ...
          <p class="md:text-2xl font-display">
            We believe in creators retaining ownership of their companies and
            IP. Our investments are structured around
    ...
    <div class="flex flex-col">
      ...
      <p class="mb-4 lg:m-0 lg:mb-0 text-xl ">
        Grants for new teams that need to get studio operations up and running, and support with impact strategy. Prepares teams for further investment and game development. 
      </p>
